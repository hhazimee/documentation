...
| **SLA** | 3 business days |
| **Runbook** | [Conduct Initial Stakeholder Identification](../runbooks/start-a-project.md) |
...
| Document | Type | Link |
|----------|------|------|
| Conduct Initial Stakeholder Identification | Runbook | [../runbooks/start-a-project.md](../runbooks/start-a-project.md) |
| Business Case | Template | [business-case.md](business-case.md) |
| Project Charter | Template | [project-charter.md](project-charter.md) |
