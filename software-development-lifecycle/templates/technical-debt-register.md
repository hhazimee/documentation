...
| **Runbook** | [Manage Technical Debt Runbook](../runbooks/implement-feature.md) |
...
|----------|------|--------------|
| Manage Technical Debt Runbook | [../runbooks/implement-feature.md](../runbooks/implement-feature.md) | Parent runbook |
| Pull Request Template | [pull-request.md](pull-request.md) | Debt may be identified during PR creation |
