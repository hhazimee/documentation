...
| **Runbook** | [Write Architecture Decision Record](../runbooks/architect-and-design.md) |
...
| Component Diagram | [component-diagram.puml](../diagrams/component-diagram.puml) | Decisions may drive component boundaries |
| System Context Diagram | [system-context-diagram.puml](../diagrams/system-context-diagram.puml) | Decisions may affect external integrations |
| Software Requirements Specification | Phase 2 SRS | Requirements referenced in Context |
| Runbook | [Write Architecture Decision Record](../runbooks/architect-and-design.md) | Step-by-step procedure |
