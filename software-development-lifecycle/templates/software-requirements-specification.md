...
| **Runbook** | [Derive Software Requirements](../runbooks/gather-requirements.md) |
...
| Artifact | Link |
|----------|------|
| Producing Runbook | [Derive Software Requirements](../runbooks/gather-requirements.md) |
...
| Use Case Template | [Use Case Template](use-case.md) |
