...
| **SLA** | 2 business days |
| **Runbook** | [Execute Test Cycle](../runbooks/run-test-cycle.md) |
...
| Type | Document | Link |
|------|----------|------|
| Runbook | Execute Test Cycle | [../runbooks/run-test-cycle.md](../runbooks/run-test-cycle.md) |
| Template | Test Case Template | [test-case.md](test-case.md) |
...
| Template | UAT Sign-Off Template | [uat-sign-off.md](uat-sign-off.md) |
