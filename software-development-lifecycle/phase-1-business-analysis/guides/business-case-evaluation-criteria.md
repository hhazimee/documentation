# Business Case Evaluation Criteria -- Quick Reference

| Field | Value |
|-------|-------|
| **Reference ID** | QR-P1-003 |
| **Use When** | Scoring, comparing, or reviewing a business case before submission for approval |
| **Last Updated** | 2026-03-04 |

---

## PRE-FLIGHT CHECK -- Before Submitting Business Case for Approval

- [ ] All evaluation criteria scored for every proposed option
...
## DECISION TABLE -- Score Interpretation

| Weighted Score | Strength | Recommended Action |
|----------------|----------|--------------------|
| 4.0 - 5.0 | Strong | Proceed to project charter; present to governance for approval |
...
## DECISION TABLE -- Per-Criterion Scoring Guide

### Strategic Alignment (1-5)

| Score | Indicator |
|-------|-----------|
| 5 | Directly enables a top-3 strategic objective; executive sponsorship confirmed |
| 4 | Supports a documented strategic objective; sponsor engaged |
| 3 | Indirect alignment with strategy; alignment rationale requires explanation |
...
| Score | Indicator |
|-------|-----------|
| 5 | Proven technology; in-house skills available; no integration unknowns |
| 4 | Established technology; minor skill gaps addressable through training |
| 3 | Technology evaluated but not yet proven in-house; integration complexity moderate |
| 2 | Emerging technology; significant skill gaps; complex integration dependencies |
| 1 | Unproven technology; critical skill gaps; high integration risk |

### Risk Profile (1-5)

| Score | Indicator |
|-------|-----------|
| 5 | All risks low after mitigation; no regulatory or compliance exposure |
| 4 | Residual risks manageable with standard controls; minor compliance considerations |
| 3 | Some medium residual risks; mitigation plans require dedicated resources |
| 2 | High residual risks in one or more areas; mitigation plans unproven |
| 1 | Critical unmitigated risks; regulatory or compliance showstoppers identified |

### Resource Availability (1-5)

| Score | Indicator |
|-------|-----------|
| 5 | All required resources confirmed available; no contention with other projects |
| 4 | Resources identified; minor scheduling adjustments needed |
| 3 | Key resources shared with other priorities; resource plan requires negotiation |
| 2 | Significant resource gaps; hiring or contracting required with uncertain timelines |
| 1 | Critical resources unavailable; no viable staffing path identified |

---

## QUICK-REFERENCE TABLE -- Scoring Worksheet
...
| **Total** | **1.00** | | **___** | | **___** | | **___** |

---

## SELECTION CRITERIA -- When to Adjust Weights
...
| Document | Type | Link |
|----------|------|------|
| Common Business Analysis Pitfalls | Quick Reference | [common-business-analysis-pitfalls.md](common-business-analysis-pitfalls.md) |
| From Business Need to Project Charter | Quick Reference | [from-business-need-to-project-charter.md](from-business-need-to-project-charter.md) |
| Business Analysis Overview | Training | [training/business-analysis-overview.md](training/business-analysis-overview.md) |
| SDLC Framework | Framework | [../../README.md](../../README.md) |
