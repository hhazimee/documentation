# From Business Need to Project Charter -- Quick Reference

| Field | Value |
|-------|-------|
| **Reference ID** | QR-P1-002 |
| **Use When** | Translating a business need through problem statement and business case into a project charter |
| **Last Updated** | 2026-03-04 |

---

## PRE-FLIGHT CHECK -- Business Need Identification

- [ ] Business need originates from a documented source (strategy, incident, regulation, user feedback)
- [ ] Sponsor or business owner identified
- [ ] Need is expressed as an outcome, not a solution
- [ ] Initial stakeholders identified
- [ ] Need aligns with at least one organizational strategic objective

---

## PRE-FLIGHT CHECK -- Problem Statement
...
## PRE-FLIGHT CHECK -- Business Case
...
## PRE-FLIGHT CHECK -- Project Charter

- [ ] Charter references the approved business case
...
- [ ] Charter signed off by sponsor and governance authority

---

## DECISION TABLE -- Stage Transitions
...
| Stage | Key Inputs | Key Outputs | Artifacts |
|-------|-----------|-------------|-----------|
...
## QUICK-REFERENCE TABLE -- Common Blockers

| Blocker | Resolution | Escalation Trigger |
|---------|------------|--------------------|
...
| Business Case Evaluation Criteria | Quick Reference | [business-case-evaluation-criteria.md](business-case-evaluation-criteria.md) |
