# Common Business Analysis Pitfalls -- Quick Reference

| Field | Value |
|-------|-------|
| **Reference ID** | QR-P1-001 |
| **Use When** | Starting or reviewing any Phase 1 business analysis activity |
...
### P1: Vague Problem Statement
- [ ] Problem statement uses specific, quantifiable language
- [ ] Problem statement answers: Who is affected? What is the impact? How large is the impact?
- [ ] Problem statement is free of solution language ("we need a system that...")

### P2: Solution-First Thinking
- [ ] Analysis started with the problem, not a predetermined solution
- [ ] Multiple solution approaches evaluated before recommendation
- [ ] Business need documented independently of any technical solution

### P3: Missing Stakeholders
- [ ] Stakeholder identification exercise completed
